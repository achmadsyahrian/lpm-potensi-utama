...
{{-- Head --}}
@section('title', 'Struktur Organisasi - ' . env('APP_NAME'))
...
@section('meta_keywords', 'struktur organisasi lpm upu,  lpm potensi utama, struktur organisasi  lpm, struktur organisasi  lpm potensi utama')
@section('canonical', env('APP_URL').'/struktur-organisasi')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #3f51b5;"><span>Struktur Organisasi</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">Struktur Organisasi</h1>
                        <img src="{{asset('landing/assets/img/profile/struktur-organisasi.jpg')}}" alt="Struktur Organisasi LPM Upu" class="img-fluid rounded shadow-sm mb-30" title="Struktur Organisasi LPM Universitas Potensi Utama" style="max-height: 500px;">

                        <h2 class="mb-30">Tugas Pokok & Fungsi</h2>
