...
{{-- Head --}}
@section('title', 'Tentang SPMI - ' . env('APP_NAME'))
...
@section('meta_keywords', 'tentang spmi lpm upu,  lpm potensi utama, tentang spmi  lpm, tentang spmi  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #6e3bc2;"><span>Tentang SPMI</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">Tentang SPMI</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
