...
{{-- Head --}}
@section('title', 'SPMI Universitas - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi universitas lpm upu,  lpm potensi utama, spmi universitas  lpm, spmi universitas  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #033493;"><span>SPMI Universitas</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI Universitas</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
