...
{{-- Head --}}
@section('title', 'SPMI Fakultas Seni & Desain - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi fsd lpm upu,  lpm potensi utama, spmi fsd  lpm, spmi fsd  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #96c95c; min-width: 280px;"><span>SPMI - Fakultas Seni & Desain</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI - Fakultas Seni & Desain</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
