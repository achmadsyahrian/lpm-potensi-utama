...
{{-- Head --}}
@section('title', 'SPMI Fakultas Hukum - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi fhukum lpm upu,  lpm potensi utama, spmi fhukum  lpm, spmi fhukum  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #0287c3; min-width: 280px;"><span>SPMI - Fakultas Hukum</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI - Fakultas Hukum</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
