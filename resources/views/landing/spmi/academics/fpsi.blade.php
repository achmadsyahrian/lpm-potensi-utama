...
{{-- Head --}}
@section('title', 'SPMI Fakultas Psikologi - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi fpsi lpm upu,  lpm potensi utama, spmi fpsi  lpm, spmi fpsi  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #7c42da; min-width: 280px;"><span>SPMI - Fakultas Psikologi</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI - Fakultas Psikologi</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
