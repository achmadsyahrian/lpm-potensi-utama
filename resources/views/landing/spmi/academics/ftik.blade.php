...
{{-- Head --}}
@section('title', 'SPMI Fakultas Teknik & Ilmu Komputer - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi ftik lpm upu,  lpm potensi utama, spmi ftik  lpm, spmi ftik  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #e58800; min-width: 350px;"><span>SPMI - Fakultas Teknik & Ilmu Komputer</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI - Fakultas Teknik & Ilmu Komputer</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
