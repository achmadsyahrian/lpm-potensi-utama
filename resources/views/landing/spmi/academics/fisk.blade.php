...
{{-- Head --}}
@section('title', 'SPMI Fakultas Ilmu Sosial & Kependidikan - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi fisk lpm upu,  lpm potensi utama, spmi fisk llpm, spmi fisk llpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #FFA07A; min-width: 350px;"><span>SPMI - Fakultas Ilmu Sosial & Kependidikan</span></p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">SPMI - Fakultas Ilmu Sosial & Kependidikan</h1>
                        <p>Coming soon..</p>
                    </div>
                </div>
