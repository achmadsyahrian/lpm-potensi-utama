...
{{-- Head --}}
@section('title', 'Kebijakan - ' . env('APP_NAME'))
...
@section('meta_keywords', 'spmi kebijakan lpm upu,  lpm potensi utama, spmi kebijakan  lpm, spmi kebijakan  lpm potensi utama')
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        <p class="tag" style="background-color: #009688;"><span>Kebijakan</span></p>
