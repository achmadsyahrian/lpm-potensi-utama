                            ...
                            <div class="row align-items-center">
                                <div class="col-10">
                                    ...
                                    <div class="markdown text-muted">
                                        Selamat datang di dashboard utama {{env('APP_NAME')}}. Di sini Anda dapat mengakses semua fitur penting dan informasi terbaru, serta berbagai layanan lainnya. Untuk informasi lebih lanjut, Anda dapat mengunduh buku panduan penggunaan website kami melalui tombol di bawah ini.
                                    </div>
                                    <div class="mt-3">
